...
jQuery(document).ready(function() {
    ...
    */
    ...
    $('.counters-container').backstretch("assets/img/backgrounds/subwaytile.jpg");
    $('.our-motto-container').backstretch("assets/img/backgrounds/baja.jpg");
    $('.call-to-action-container').backstretch("assets/img/backgrounds/1.jpg");
		$('.event-container').backstretch("assets/img/backgrounds/event.jpg");
